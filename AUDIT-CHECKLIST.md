...
| 2026-06-08 | main (pre-baseline-v2.0.9-contract) | Contract hygiene baseline. T1 PASS: lines=90.27%≥65%, functions=79.31%≥45%, branches=42.89%≥35%, statements=90.27%≥65%. T2 PASS: 0 skips. T3 PASS: no new `src/tools/` modules; changed `constants`, product/customer metafield readers, and added e2e coverage. Typecheck PASS. Build PASS. 97 tests, 0 failures, including Gadget fixture schema compatibility and runtime version coverage. | ✅ PASS |
